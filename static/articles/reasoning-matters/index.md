---
title: "Reasoning matters - Resolve."
description: "Reasoning traces are valuable. They can tell you a lot about your prompt. Unless your provider has decided you may not look."
...
The reasoning is different. "Inference" — drawing a conclusion from premises, step by step — is what can be learned from. I learned prompting, and how to reason *with* these models, from these reasoning traces — watching where my words landed, watching a first thought march off in a direction I never intended.
